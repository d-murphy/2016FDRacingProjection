...
In this document, the data results from the year are summarized which is used to simulate future resuts.  Finially, the results of the simulation are summarized to provide the basis for the projection.  
...
#####  Need to make time adjustment before working this out.  
